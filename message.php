  ...
  <section id="container" class="">
                ...
                <ul class="nav pull-right top-menu">         
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">Camposano, Dion John A.</span>
                            <b class="caret"></b>
                        </a>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="active" href="basic_table.php">Students Table</a></li>
                      </ul>
                  </li>
				  <li>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="glyphicon glyphicon-envelope"></i> Message Students</h3>
				</div>
			</div>
